...
<div class="container"> 
    ...
    <div class="row">
        <div class="container">
            <a href="index.php?uc=genererScriptSQL&action=sauvegardeGenererScriptSQL">
                <button 
            ...
            <a href="index.php?uc=genererScriptSQL&action=restaurationScriptSQL">
                <button 
                    class="btn btn-info btn-2">
                    <span>
